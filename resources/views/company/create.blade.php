                ...
                <form action="{{ route('company.store') }}" method="post" enctype="multipart/form-data" id="companyForm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="logo" class="form-control-label">Logo (Min 100x100px):<span style="color: red;">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="website" value="{{ old('website') }}" pattern="^(https:\/\/)?([a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?)?$" title="Please enter a valid website URL">
                                </div>
                            </div>
                        </div>
                        <button type="submit" id="submit" class="btn btn-primary">Create Company</button>
                    </div>
                </form>
            </div>
        </div>
